...
import {RiShoppingCart2Line,IoCloseOutline,MdSearch,BsArrowRightShort, IoLogOutOutline, MdKeyboardArrowRight,CgProfile, IoChevronDownCircleOutline, IoMdArrowDropdown, AiOutlineLogout} from "react-icons/all"
 ...
 const Nav = ({history}) => {
    ...
    return (
       <nav ref = {Nav}  className={`nav ${nav ? 'active' : ''}`} >
           <div className="logo"><Link to =''>ESHOP</Link></div>
