    ...
    return (
        ...
        <div className = 'Cgfilter'>
            ...
            <ul>
                    ...
                    <Link className = 'lined'  to = '?cg=Men'>Meat</Link>
                    <Link className = 'lined'  to = '?cg=Women'>Fish</Link>
                    <Link className = 'lined'  to = '?cg=Watches'>Milk</Link>
                    <Link className = 'lined' to = '?cg=Shoes'>Snacks</Link>
                    <Link to = '?cg=Bag' className = 'lined'>Beverage</Link>
            </ul>
            </div>
        </div>
