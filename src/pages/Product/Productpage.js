        ...
        <div className = "img-display">
          ...
          <div className = "img-select">
            <div className = "img-item">
              <a href = "#" data-id = "1">
                <Image  objectFit="cover" boxSize = '200px' src = {product.image} alt = "shoe image"/>
        ...
        <div className = "product-content">
          ...
          <div className = "product-detail">
           ...
           {/* <ul>
            ...
            <Button onClick={addToCartHandler} type = "button"  className = "btn-shop"> <AiFillShop size='24' />Add to Cart </Button>
          </div>
